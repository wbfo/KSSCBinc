            ...
            <section className="py-20 md:py-32 bg-white relative overflow-hidden">
                ...
                <div className="w-full max-w-[1200px] mx-auto px-4 relative z-10">
                    ...
                    <div className="max-w-[850px] mx-auto">
                        {[
                            { num: "1", name: "Franklin Wlehka Tuweh", role: "Primary Founder & Executive Director", desc: "Based in the United States (NYC area), Franklin brings extensive experience in U.S. non-profit administration to KSSCB Inc. He directs the strategic vision and funding operations from afar, working hand-in-hand with his co-founders who execute the mission on the ground in Africa." },
                            { num: "2", name: "Patrick C. Kumeh", role: "Co-Founder (On the Ground in Liberia)", desc: "Patrick is a committed community leader and co-founder serving as the crucial 'boots on the ground' in Sarbo Sweaken City, Africa. His on-the-ground knowledge of the community's needs and his daily management of operations are invaluable to KSSCB Inc.'s hands-on mission." },
                            { num: "3", name: "Reverend Thomas Johnson Sr.", role: "Additional Founder & Community Liaison", desc: "Working alongside Patrick on the ground in Liberia, Reverend Johnson brings moral authority, community trust, and decades of civic engagement to the leadership of KSSCB Inc. His daily presence strengthens the organization's bond with the local faith community in Africa." }
                        ].map((leader, i) => (
                            <motion.div
                                key={i}
